    ...
    >
      ...
      <div className="tp-surface p-4 mb-6 flex flex-wrap items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" className="z-[100] min-w-[220px] bg-[#0d0d0d] border-2 border-[hsl(var(--tp-gold))] text-[hsl(var(--tp-text))] shadow-2xl p-1 [&_[role=menuitem]]:text-[hsl(var(--tp-text))] [&_[role=menuitem]]:cursor-pointer [&_[role=menuitem]:focus]:bg-[hsl(var(--tp-gold))] [&_[role=menuitem]:focus]:text-black [&_[role=menuitem][data-disabled]]:opacity-50"z-50 bg-[hsl(var(--tp-surface-3))] border border-[hsl(var(--tp-hairline-strong))] text-[hsl(var(--tp-text))] shadow-2xl"_[role=menuitem]]:text-[hsl(var(--tp-text))] [className="z-50 bg-[hsl(var(--tp-surface-3))] border border-[hsl(var(--tp-hairline-strong))] text-[hsl(var(--tp-text))] shadow-2xl"_[role=menuitem]]:cursor-pointer [className="z-50 bg-[hsl(var(--tp-surface-3))] border border-[hsl(var(--tp-hairline-strong))] text-[hsl(var(--tp-text))] shadow-2xl"_[role=menuitem]:focus]:bg-[hsl(var(--tp-gold))] [className="z-50 bg-[hsl(var(--tp-surface-3))] border border-[hsl(var(--tp-hairline-strong))] text-[hsl(var(--tp-text))] shadow-2xl"_[role=menuitem]:focus]:text-black">
